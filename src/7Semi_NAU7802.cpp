...
// // {
// //     i2c = &wire;
// //     address = 0x2A; // default I2C address
// // }
...
// //      *
// //      * Inputs:
// //      * - sda   : optional SDA pin for ESP platforms (0xFF = default)
// //      * - scl   : optional SCL pin for ESP platforms (0xFF = default)
// //      * - speed : I2C clock speed in Hz (default 400000)
// //      *
// //      * Return:
// //      * - true  : I2C bus started and initSensor() succeeded
// //      * - false : initSensor() failed (sensor not detected / config failed)
// //      */
...
// //     if(!writeReg(REG_PU_CTRL, 0x01)) return false;
// //     delay(10);
...
// //     v &= 0xF8;             // clear LDO+gain bits
// //     v |= ((ldo << 3) | gain) & 0x07F; // set new values safely
...
// //     if (powerUP)
// //     {
// //         writeReg(REG_PU_CTRL, 0x06); // Power up digital+analog
...
// //                 return false;
// //             if (val & (1 << 3)) // Check power ready bit
// //                 break;
// //             if (millis() - start > 100)
// //                 return false;
// //         }
...
// //     {
// //         int32_t raw;
// //         if (readRaw(raw, maxTimeout / numSamples)) // divide timeout across samples
// //         {
// //             sum += raw;
// //             count++;
// //         }
...
// // bool NAU7802_7Semi::tare(uint8_t numSamples, unsigned long maxTimeout)
// // {
// //     int32_t avg;
// //     if (!readAverage(avg, numSamples, maxTimeout))
// //         return false;
...
// // {
// //     if (knownWeight == 0) return false; // avoid divide by zero
...
// // // Get weight in units
// // bool NAU7802_7Semi::getWeight(float &weight, bool allowNegative, uint8_t numSamples, unsigned long maxTimeout)
// // {
...
// //     i2c->requestFrom(address, (uint8_t)3);

// //     uint32_t value = ((uint32_t)i2c->read() << 16) |
// //                      ((uint32_t)i2c->read() << 8) |
// //                      i2c->read();
...
// // // void NAU7802_7Semi::tare(uint8_t samples, uint32_t timeout)
// // // {
// // //     int64_t sum = 0;
// // //     uint8_t count = 0;
...
// // // void NAU7802_7Semi::calibrate(float knownWeight,
// // //                              uint8_t samples,
// // //                              uint32_t timeout)
// // // {
// // //     int64_t sum = 0;
...
// // // float NAU7802_7Semi::getWeight(bool allowNegative,
// // //                               uint8_t samples,
// // //                               uint32_t timeout)
// // // {
// // //     int64_t sum = 0;
...
//     startReading();
//     int32_t tmp;
//     readRaw(tmp, 100); // dummy read
//     return true;
// }

// // Configure LDO voltage and PGA gain
// bool NAU7802_7Semi::setConfig(LDO_Output_Voltage ldo, PGA_gain_select gain)
// {
//     uint8_t v;
//     if(!readReg(REG_CTRL1, v)) return false;

//     v &= 0xC7; // clear LDO bits (3-5) and gain bits (0-2)
...
//     if (powerUP)
//     {
//         if(!writeReg(REG_PU_CTRL, 0x06)) return false; // digital+analog
//         unsigned long start = millis();
//         uint8_t val;
//         while (true)
//         {
...
// void NAU7802_7Semi::setSampling(uint8_t average_samples, unsigned long readTimeout)
// {
//     samples = max(1, average_samples);
//     timeout = max(1UL, readTimeout);
// }
 ...
 * - readTimeout     : preferred timeout in ms (minimum 1)
 *
 * User note:
 ...
 * - allowNegative : if false, negative net counts are clipped to 0
 * - numSamples    : averaging samples for this measurement
 * - maxTimeout    : timeout budget in ms for this measurement
 *
 * Return:
